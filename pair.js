            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'OJO CODERS-BOT~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of OJO CODERS-BOT.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029VbAy2cVIN9iuPoKRub3B) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [OJO CODERS GitHub Repo](https://github.com/Ojohacker/)  

🚀 _Thanks for choosing OJO CODERS-BOT — Let the automation begin!_ ✨`;
